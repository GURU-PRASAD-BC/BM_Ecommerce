      ...
      if (password === confirmPassword) {
        try {
          ...
          const emailCheckResponse = await axios.get(
            `https://bm-ecommerce-backend.onrender.com/users?email=${email}`
          );
          ...
          const phoneCheckResponse = await axios.get(
            `https://bm-ecommerce-backend.onrender.com/users?phone=${phone}`
          );
          ...
          const response = await axios.post(
            'https://bm-ecommerce-backend.onrender.com/users',
            userData,
            {
              headers: {
