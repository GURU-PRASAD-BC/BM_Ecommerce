...
const Checkout = () => {
  ...
  const createOrder = async () => {
    try {
      ...
      const response = await axios.post('https://bm-ecommerce-backend.onrender.com/orders', order);
  ...
  const updateProductStock = async () => {
    try {
      for (const item of cart.items) {
        ...
        await axios.patch(`https://bm-ecommerce-backend.onrender.com/products/${item.id}`, { quantity_stock: updatedStock });
  ...
  const handleOrderDelivered = async () => {
    try {
      await axios.patch(`https://bm-ecommerce-backend.onrender.com/orders/${orderID}`, { order_status: 'delivered' });
      Swal.fire({
        icon: 'success',
            ...
            <div className="col-md-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">Delivered By : {selectedDeliveryOption === 'amana' ? 'Ekart' : 'BlueBird'}</p>
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="deliveryAmana">Delivery by Ekart 24h: 30.00 DH</label>
                  </div>
                  <div className="form-check">
                    <input
                      type="radio"
                    ...
                    />
                    <label className="form-check-label" htmlFor="deliveryOzone">Delivery by BlueBird 48h: 20.00 DH</label>
                  </div>
                </div>
                <div className="card-footer text-center">
                  ...
                  <img src={qrCodeImage} style={{ height: '400px', width: '400px' }}/>
